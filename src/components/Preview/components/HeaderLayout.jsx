    ...
    return (
        <>
            ...
            <nav className='flex items-center justify-between py-3 relative h-32 lg:px-14 px-4 bg-[#f2f2f2] z-20'>
                <Bounce left>
                    <Link href='/preview' className='md:w-56 w-32 2xl:scale-125 2xl:hover:scale-150 transform transition-all duration-500 ease-in-out relative top-7'>
                        <Image
                ...
                <Bounce right>
                    <ul className='lg:flex flex-wrap relative hidden px-10 uppercase'>
                        ...
                        <li className='h-10'>
                            <div className="group">
                                <button
                                    className='px-4 py-1 hover:text-white font-semibold z-20 hover:bg-[#4dcdc5] text-[#4dcdc5] transition-all duration-100 ease-in-out w-36 flex items-center justify-between uppercase'
                                >
                                    {t("About Us")}
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                    ...
                    {/* mobile */}
                    <div className={`flex flex-col fixed bg-[#4dcdc5] px-5 right-0 w-full z-20 pt-8 pb-4 ${ toggle ? "h-screen top-0" : "h-0 pb-0 pt-0 -top-14" } transition-all duration-500 lg:hidden overflow-hidden gap-4`}>
                        {/* <h2>{t("us")}</h2> */}
                        {/* <Link
                            href='/donation'
                        ...
                        <div className="group w-full">
                            <button
                                className='px-4 py-1 text-white hover:bg-white hover:text-[#4dcdc5] font-semibold z-20 uppercase w-full text-start'
                            >
                                {t("Registration Campaign")}
