...
import { BannerRegister } from "../../../atoms/BannerRegister/BannerRegister";
									...
									<div className={classes.modal__contentMainStepper}>
										<div>
											...
											<div>
												<div
													style={{
														background: nextSection ? "#fff" : "#45b7e1",
														color: nextSection ? "#45b7e1" : "#fff",
												...
												<div
													style={{
														background: nextSection ? "#45b7e1" : "#fff",
