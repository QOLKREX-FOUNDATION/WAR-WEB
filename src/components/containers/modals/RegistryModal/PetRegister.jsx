...
import { ModalCheckbox } from "../../../atoms/inputs/ModalCheckbox/ModalCheckbox";
import { ModalChipInputComponent } from "../../../molecules/ModalChipInputComponent/ModalChipInputComponent";
					...
					{isFiat && (
						<div className={classes.modal__contentMainFormPaymentFiat}>
							...
							<a
								href={
									haveChip
										? "https://api.openpay.pe/occ/T5KT3HUtyuiJ"
