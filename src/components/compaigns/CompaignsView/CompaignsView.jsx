    ...
    return (
        <div className="">
            ...
            <div className="flex flex-col justify-center px-10 gap-3 py-10">
                <Zoom top big>
                    <h2 className='text-center font-semibold text-2xl text-[#0ea5e9]'>{t("Campaigns - Donations")}</h2>
                </Zoom>
                            ...
                            >
                                <SwiperSlide>
                                    <div className='w-80 h-full bg-[#cfefed] px-5 py-3 rounded-2xl'>
                                        ...
                                        <div className='flex flex-col gap-3 py-2'>
                                            <h3 className='font-semibold text-[#0ea5e9]'>{t("VicuID Project")}</h3>
                                ...
                                <SwiperSlide>
                                    <div className='w-80 h-full bg-[#cfefed] px-5 py-3 rounded-2xl'>
                                        ...
                                        <div className='flex flex-col gap-3 py-2'>
                                            <h3 className='font-semibold text-[#0ea5e9]'>{t("Spectacled bear")}</h3>
                                            <p className="max-h-72 overflow-hidden">
                                                {t(
