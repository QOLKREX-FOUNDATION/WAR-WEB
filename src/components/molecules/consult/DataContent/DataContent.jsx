						...
						<div className={classes.contentInfo__cards}>
							...
							<div>
								<div className={classes.contentInfo__cardsText}>
									...
									{!dataPet.pet?.userAddress && <span>{t("Not specified")}</span>}
									<br />
							...
							<div className={classes.contentInfo__generalTable}>
												...
												<>
													{races.map(
														(race) => {
															...
															return race.value.toUpperCase().trim() === dataPet.pet?.race.toUpperCase().trim() && race.label
														}
													)}
												</>
											)}
								...
								<div>
									...
									{dataPet.pet?.gender != undefined && (
										<span>
											{dataPet.type === "RENIAN" ? (
												dataPet.pet?.gender === 'MACHO' ? t("Male") : t("Female")
											) : (
												<>
